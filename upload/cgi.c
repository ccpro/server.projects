...
#ifdef DEBUG
static char *rcsid = "$Id: cgi.c,v 1.2 2007/03/30 20:55:53 ccpro Exp $";
#endif
 ...
 * remove_one_value()
 * ============
 *    This routine removes a single CGI value from the list
 ***************************************************************************/
int remove_one_value(char *name)
{  
 t_cgi_vars *tmp = cgi_vars;
 t_cgi_vars *caboose = NULL;
 int rc = 0;
