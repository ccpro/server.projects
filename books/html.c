...
#ifdef DEBUG
static char *rcsid = "$Id: html.c,v 1.1.1.1 2005/09/28 20:32:42 ccpro Exp $";
#endif
...
{
   printf("<TABLE BORDER=0 CELLSPACING=1 WIDTH=100%%>\n");
} 
/****************************************************************************
 * table_500_start()
 ***************************************************************************/
...
{
   printf("<TABLE BORDER=0 CELLSPACING=1 CELLPADDING=3 WIDTH=500>\n");
} 
/****************************************************************************
 * table_start()
 ***************************************************************************/
...
//   }
   ...
   if (strcmp(content_type, "text/plain")) {
      ...
      printf("<HEADER>\n"
             ...
             "<LINK REL='stylesheet' TYPE='text/css' HREF='/styles/blueprint.CSS'>\n"
             "</HEADER>\n", title ? title : "");
